  ...
  return (
    <div className="flex min-h-[70vh] flex-col items-center px-5 md:px-0">
      <div className="mt-10 flex w-full max-w-2xl flex-col p-2.5">
        ...
        <li className="mt-3 list-disc text-[#FFFFFF75]">Built-In Support for Next.js 12.1</li>
        <li className="mt-3 list-disc text-[#FFFFFF75]">Static Pre-rendering to warm cache as soon as the app is in production</li>
        <li className="mt-3 list-disc text-[#FFFFFF75]"></li>
